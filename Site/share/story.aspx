<%@ Page Language="C#" MasterPageFile="~/master/ShareMasterPage.master" AutoEventWireup="true" CodeFile="story.aspx.cs" Inherits="share_story" Title="Top Of The Rock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentBodyHolder" Runat="Server">
    ...
    <div class="shareFPhoto" id="div_Holder" runat="server" style="top:100px;left:510px;width:327px;height:270px;">
    </div>
</asp:Content>
