<%@ Page Language="C#" MasterPageFile="~/master/SecureAdminMasterPage.master" Theme="Admin" AutoEventWireup="true" CodeFile="StoryCategoryList.aspx.cs" Inherits="admin_StoryCategoryList" Title="Story Category" %>
