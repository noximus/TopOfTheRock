<%@ Page Language="C#" MasterPageFile="~/master/SecureAdminMasterPage.master" Theme="Admin" AutoEventWireup="true" CodeFile="History.aspx.cs" Inherits="admin_History" Title="Edit History" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphNav" Runat="Server">
<ul>
    <li id="liHistory" runat="server" class="active"><a href="History.aspx">History</a></li>
...
<asp:Repeater ID="rpt_History" runat="server">
    <ItemTemplate>
        <fieldset>
            ...
            <tr>
                <td class="label" style="vertical-align:top;"><label class="required" for="txt_Desc">Image:</label></td>
                <td><asp:FileUpload ID="fu_Image" runat="server" />
                    <asp:RequiredFieldValidator ControlToValidate="fu_Image" ID="val_Image" 
                    runat="server" Display="Dynamic" ErrorMessage="Image is required." />
...
<table border="0" cellpadding="0" cellspacing="0" visible="true" class="form" style="width: 642px">
    <tr>
        <td><asp:Button ID="btnSaveHistory" runat="server" Text="Save" OnClick="Save_Click"/></td>
    </tr>
</table>
