<%@ Page Language="C#" MasterPageFile="~/master/VisitorMasterPage.master" AutoEventWireup="true" CodeFile="jp.aspx.cs" Inherits="visitor_Default" Title="Top Of The Rock" %>
    ...
    <div class="generalButton" style="left:500px;top:22px;">
		...
		<script type="text/javascript">
	        // <![CDATA[
		        ...
		        so.addVariable("selectFlag","3");
		        so.write("DivFlag");
	        // ]]>
        </script>    
    </div>
    
    <div class="visitorJPBg"></div>
